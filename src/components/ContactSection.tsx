                  ...
                  <div className="relative z-10" ref={formInnerRef} style={{ opacity: 1 }}>
                    ...
                    {!formSubmitted ? (
                      <>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                          <div>
                            <label htmlFor="name-desktop" className="block text-white/80 mb-1.5 text-sm">Your Name</label>
                            <input
                              type="text"
                              id="name-desktop"
                              name="name"
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                              <label htmlFor="email-desktop" className="block text-white/80 mb-1.5 text-sm">Email Address</label>
                              <input
                                type="email"
                                id="email-desktop"
                                name="email"
                            ...
                            <div>
                              <label htmlFor="phone-desktop" className="block text-white/80 mb-1.5 text-sm">Phone Number <span className="text-white/40">(Optional)</span></label>
                              <input
                                type="tel"
                                id="phone-desktop"
                                name="phone"
                          ...
                          <div>
                            <label htmlFor="message-desktop" className="block text-white/80 mb-1.5 text-sm">Your Message</label>
                            <textarea
                              id="message-desktop"
                              name="message"
                              value={formData.message}
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-3 gap-x-4 gap-y-2">
                              {serviceOptions.map((service, index) => (
                                <div key={index} className="flex items-center">
                                  <input
                                    type="checkbox"
                                    id={`service-desktop-${index}`}
                                    checked={formData.services.includes(service)}
                                    onChange={() => handleServiceChange(service)}
                                    className="w-4 h-4 accent-accent mr-2 bg-bg-darker border-white/20"
                                  />
                                  <label 
                                    htmlFor={`service-desktop-${index}`} 
                                    className="text-sm text-white/70 cursor-pointer hover:text-white"
                                  >
                                    {service}
                                  </label>
                          ...
                          <div>
                            <label htmlFor="fileUpload-desktop" className="block text-white/80 mb-1.5 text-sm">Attach a File <span className="text-white/40">(Optional)</span></label>
                            <div className="flex items-center gap-3">
                              <input
                                type="file"
                                ...
                                onChange={(e) => {
                                  const fileName = e.target.files?.[0]?.name || 'No file chosen';
                                  const fileLabel = document.getElementById('fileLabel-desktop');
                                  if (fileLabel) fileLabel.textContent = fileName;
                                }}
                              />
                              <button
                                type="button"
                                onClick={() => document.getElementById('fileUpload-desktop')?.click()}
                                className="px-4 py-2 bg-accent/20 hover:bg-accent/30 rounded-md text-white text-sm transition-colors"
                              >
                                Choose File
                              </button>
                              <span id="fileLabel-desktop" className="text-white/60 text-sm truncate">No file chosen</span>
                            </div>
                            <p className="text-white/40 text-xs mt-1">Max file size: 5MB. Supported formats: PDF, DOC, DOCX, JPG, PNG</p>
                          </div>
                          <div className="flex items-start">
                            <input
                              ...
                              className="w-4 h-4 accent-accent mt-1 mr-2 bg-bg-darker border-white/20"
                            />
                            <label htmlFor="gdprConsent-desktop" className="text-sm text-white/70">
                              I consent to True Node collecting my data. 
                              <a 
                                href="/privacy-policy" 
                                target="_blank" 
